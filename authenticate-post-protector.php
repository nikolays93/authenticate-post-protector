...
const DOMAIN = 'authenticate-post-protector';
...
class Plugin
{
    ...
    private static function include_required_files()
    {
        ...
        // includes
        Utils::load_file_if_exists( $plugin_dir . '/includes/post-metabox.php' );
        Utils::load_file_if_exists( $plugin_dir . '/includes/post-content-filter.php' );
    }
}
